...
RESOURCES += src/qt/calypso.qrc src/qt/calypso_locale.qrc

TRANSLATIONS += src/qt/locale/calypso_bg.ts \
                src/qt/locale/calypso_de.ts \
                src/qt/locale/calypso_en.ts \
                src/qt/locale/calypso_es.ts \
                src/qt/locale/calypso_fi.ts \
                src/qt/locale/calypso_fr.ts \
                src/qt/locale/calypso_it.ts \
                src/qt/locale/calypso_ja.ts \
                src/qt/locale/calypso_pl.ts \
                src/qt/locale/calypso_pt.ts \
                src/qt/locale/calypso_ru.ts \
                src/qt/locale/calypso_sk.ts \
                src/qt/locale/calypso_sv.ts \
                src/qt/locale/calypso_vi.ts \
                src/qt/locale/calypso_zh_CN.ts \
                src/qt/locale/calypso_zh_TW.ts
