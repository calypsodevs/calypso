...
#   c) node1 mines 32 blocks, so now node 0 has 60001clp, node 1 has 4250clp, node2 has none.
#   d) node0 sends 601 clp to node2, in two transactions (301 clp, then 300 clp).
