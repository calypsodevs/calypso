Contributing to CALYPSO Core
============================

The CALYPSO Core project operates an open contributor model where anyone is
...
The following applies to code changes to the CALYPSO Core project, and is not to be
confused with overall CALYPSO Network Protocol consensus changes.

Whether a pull request is merged into CALYPSO Core rests with the project merge
...
Patches that change CALYPSO consensus rules are considerably more involved than
...
Where a patch set proposes to change the CALYPSO consensus, it must have been
...
The project leader is the release manager for each CALYPSO Core release.
