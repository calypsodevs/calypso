...
/**
 * CALYPSO RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern UniValue setzclpseed(const UniValue& params, bool fHelp);
extern UniValue getzclpseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzclp(const UniValue& params, bool fHelp);
extern UniValue dzclpstate(const UniValue& params, bool fHelp);
