...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    StartShutdown();
    return "CALYPSO server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* CALYPSO features */
        {"calypso", "masternode", &masternode, true, true, false},
        {"calypso", "listmasternodes", &listmasternodes, true, true, false},
        {"calypso", "getmasternodecount", &getmasternodecount, true, true, false},
        {"calypso", "masternodeconnect", &masternodeconnect, true, true, false},
        {"calypso", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"calypso", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"calypso", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"calypso", "masternodecurrent", &masternodecurrent, true, true, false},
        {"calypso", "masternodedebug", &masternodedebug, true, true, false},
        {"calypso", "startmasternode", &startmasternode, true, true, false},
        {"calypso", "createmasternodekey", &createmasternodekey, true, true, false},
        {"calypso", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"calypso", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"calypso", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"calypso", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"calypso", "getmasternodescores", &getmasternodescores, true, true, false},
        {"calypso", "mnbudget", &mnbudget, true, true, false},
        {"calypso", "preparebudget", &preparebudget, true, true, false},
        {"calypso", "submitbudget", &submitbudget, true, true, false},
        {"calypso", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"calypso", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"calypso", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"calypso", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"calypso", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"calypso", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"calypso", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"calypso", "checkbudgets", &checkbudgets, true, true, false},
        {"calypso", "mnsync", &mnsync, true, true, false},
        {"calypso", "spork", &spork, true, true, false},
        {"calypso", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzclpseed", &getzclpseed, false, false, true},
        {"zerocoin", "setzclpseed", &setzclpseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzclp", &searchdzclp, false, false, true},
        {"zerocoin", "dzclpstate", &dzclpstate, false, false, true}
...
{
    return "> calypso-cli " + methodname + " " + args + "\n";
}
