...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Calypso Core calypso-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  calypso-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded calypso transaction") + "\n" +
                               "  calypso-tx [options] -create [commands]   " + _("Create hex-encoded calypso transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded calypso transaction
