...
/** Utility functions used by the CALYPSO Qt UI.
 */
namespace GUIUtil
{
...
// Render CALYPSO addresses in monospace font
...
// Parse "calypso:" URI into recipient object, return true on successful parsing
