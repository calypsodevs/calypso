                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("CALYPSO Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a CALYPSO address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and calypso: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zCLP"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About CALYPSO Core"), this);
    aboutAction->setStatusTip(tr("Show information about CALYPSO Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for CALYPSO"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your CALYPSO addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified CALYPSO addresses"));
    ...
    openAction->setStatusTip(tr("Open a CALYPSO: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the CALYPSO Core help message to get a list with possible CALYPSO command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("CALYPSO Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to CALYPSO network", "", count));
}
...
{
    QString strTitle = tr("CALYPSO Core"); // default title
