...
/* Calypso GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "CALYPSO"
#define QAPP_ORG_DOMAIN "calypso.org"
#define QAPP_APP_NAME_DEFAULT "CALYPSO-Qt"
#define QAPP_APP_NAME_TESTNET "CALYPSO-Qt-testnet"
