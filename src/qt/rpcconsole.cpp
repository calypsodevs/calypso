                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzCLPPathCustom = GetArg("-zclpbackuppath", "");
    ...
    if(!strzCLPPathCustom.empty()) {
        ui->wallet_customzclpbackuppath->setText(QString::fromStdString(strzCLPPathCustom));
        ui->wallet_customzclpbackuppath_label->setVisible(true);
        ui->wallet_customzclpbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzCLPPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the CALYPSO RPC console.") + "<br>" +
