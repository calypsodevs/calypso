...
In order to support loading of multiple wallets in calypso-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is calypso.cpp.
...
Changes to calypso.cpp
----------------------
calypso.cpp is the entry point into calypso-qt, and as such, will require some minor modifications to provide hooks for
