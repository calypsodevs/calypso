...
This mechanism has been integrated into Bitcore-Node-CALYPSO which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/CALYPSO-Project/insight-api-calypso#web-socket-api](https://github.com/CALYPSO-Project/insight-api-calypso#web-socket-api) 
* API: [https://github.com/CALYPSO-Project/insight-api-calypso#swifttx-transactions](https://github.com/CALYPSO-Project/insight-api-calypso#swifttx-transactions) 
...
By default, the CALYPSO Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the CALYPSO Core daemon:
